...
let dmbtn = document.getElementById("dm");
...
navSearchBtn.addEventListener("click", function () {
  maincnt.innerHTML = `<section id="search" class="search">
        <div class="container serc">
          <h4 class="mb-4">
            Search for a <span class="frymain">Recipe</span>
          </h4>
          <input
            type="text"
        ...
        <div class="container mb-3" id="searchresults">
...
navAboutBtn.addEventListener("click", function () {
  maincnt.innerHTML = `<section id="About" class="about">
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 mt-4">
            <div class="col-md-12 m-auto borders d-flex align-items-center">
             <div class=""> <img src="fry&herb/Fry&Herb web main.png" alt="Developer 3" class="img-fluid rounded-circle mb-2"></div>
              <div class="ms-3 col-8">
                <h2>Vhmed</h2>
                <p class="frymain">Front-end Developer - Ui/UX Designer</p>
              </div><div class="d-flex col-4 ">
            <a href="https://www.behance.net/Ahmed_Hossam16" class="text-decoration-none btn1 m-auto">
              <p style="color: #053eff;"><i class="fa-brands fa-square-behance" ></i>Behance</p></a>
            <a href="https://github.com/Vhmed-hossam" class="text-decoration-none btn1 m-auto">
              <p style="color: #FFF;"><i class="fa-brands fa-square-github"></i>Github</p></a></div>
        </div>
            </div>
          </div>
        <div class="container mt-5">
          ...
          <div>
            ...
            id="searchval"
          />
          <a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJqWgZzQCWKzQKwsCtjwTVbDmSkctlbHcQtGSsJjLtljmVGMgWRsccVzXtgQHjPNwmvrMLB"><button class="searchbtn" id="searchbtn" >
...
navSettingsBtn.addEventListener("click", function () {
  maincnt.innerHTML = `<section id="Settings" class="settings">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h2>Settings</h2>
        ...
        <div class="text-center">
          <div class="m-auto"><p>Mode</p>
            <button id="dm" class="btn1" onclick="DarkMode()">Dark Mode</button></div>
        </div>
      </div>
    </div>
</section>`;
...
navHomeBtn.addEventListener("click", function () {
  maincnt.innerHTML = `<section id="home" class="home">
    <div class="container">
      <div class="row">
        <div class="col-12">
        ...
        <div class="col-lg-12 borders mt-4 p-2">
          <div class="d-flex align-items-center justify-content-between">
            <div>
              ...
              <p class="w-75">At <span class="frymain">Fry&Herb</span>, we’re passionate about making cooking easy,
                enjoyable, and accessible to everyone. Explore a vast collection of carefully 
                curated recipes, step-by-step cooking guides, and tips to help you create 
                delicious meals.</p>
            </div>
            <div>
